...
class StarterSite extends TimberSite {
    ...
    function __construct() {
        ...
        add_image_size ( 'serviceMenuLarge', 600, 600, true );
        add_image_size ( 'serviceMenuMedium', 400, 400, true );
        add_image_size ( 'serviceMenuSmall', 200, 200, true );
    ...
    function add_to_context( $context ) {
        ...
        $context['pageSettingsHideFeatureImage'] = get_field('hide_feature_image', $post_id);
