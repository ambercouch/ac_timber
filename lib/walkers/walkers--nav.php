...
class Ac_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        $output .= "{$n}{$indent}<div class='c-nav-menu__nav-sub-menu ac-cmt-walker'  data-state='off' data-container='submenu_".$this->curItem->ID."' ><div class='c-nav-sub-menu'><ul $class_names>{$n}";
    }
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $classes[] = 'depth-'.$depth.$item_class.'--'.$slug.' menu-item-' . $item->ID;
        ...
        $atts = array();
        $atts['class'] = ! empty( $item->class ) ? $item->attr_class.$link_class.'--'.$slug.' ' : $link_class.'--'.$slug;
